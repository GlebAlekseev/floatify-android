...
abstract class FloatingView(protected val context: Context) {
    ...
    open val layoutWidth: Int = WindowManager.LayoutParams.MATCH_PARENT
    open val layoutHeight: Int = WindowManager.LayoutParams.MATCH_PARENT
...
//            flags or FLAG_NOT_FOCUSABLE or FLAG_NOT_TOUCH_MODAL or FLAG_NOT_TOUCHABLE,
            flags,
